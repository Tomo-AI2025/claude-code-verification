...
- [arxiv 2603.20847](https://arxiv.org/abs/2603.20847)(FSE '26)は Claude Code の 3,800 件の実問題を分析し、**67% が機能バグ**、うち 37.3% が API/統合のミスマッチに起因すると報告しています。これは Part 1 の「サイレント・フェイラー」と同じカテゴリです。
- [arxiv 2604.08906](https://arxiv.org/abs/2604.08906) は agentic LLM フレームワーク全般で silent semantic error を記録しています。本稿の Pattern #7 はその具体的かつ測定可能なインスタンスに相当します。
...
1. [arxiv 2603.20847](https://arxiv.org/abs/2603.20847) — *A Systematic Study of Bug Patterns in Claude Code*(FSE '26)。3,800 件の issue 分析、うち 67% が機能バグ。
2. [arxiv 2604.08906](https://arxiv.org/abs/2604.08906) — agentic LLM フレームワーク全般における silent semantic error。
